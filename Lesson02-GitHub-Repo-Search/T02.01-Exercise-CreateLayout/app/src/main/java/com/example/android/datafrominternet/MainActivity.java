...
public class MainActivity extends AppCompatActivity {
    ...
    TextView mUrlDipslayTextView;
    TextView mSerachResultTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUrlDipslayTextView = (TextView) findViewById(R.id.tv_url_display);
        // TODO (31) Use findViewById to get a reference to mSearchResultsTextView
        mSerachResultTextView = (TextView) findViewById(R.id.tv_github_search_results_json);
    }
}
